...
export function createChatCompletionsRouter(deps: {
  store: JobStore;
  ...
  router.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      if (mode === 'sync') {
        const result = await openclaw.call({
      ...
      // Limpa o body original pra que o forward pro OpenClaw não inclua webhook_*
